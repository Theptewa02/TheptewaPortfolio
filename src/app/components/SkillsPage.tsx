  ...
  return (
    <SectionWrapper>
      <div className="max-w-full py-8 space-y-12">
        ...
        <div className="grid grid-cols-6 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {skillsAndTools.map((item, i) => (
            ...
            <SpotlightCard
              key={i}
              spotlightColor="rgba(0, 156, 228, 0.3)"
              // className="bg-gradient-to-r from-cyan-400 via-sky-500 to-blue-600"
            >
              <div className="flex flex-col items-center rounded-3xl bg-neutral-900">
                {item.node}
                <span className="mt-3 text-white font-semibold">{item.title}</span>
              </div>
            </SpotlightCard>
